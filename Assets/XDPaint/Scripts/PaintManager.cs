...
namespace XDPaint
{
    public class PaintManager : MonoBehaviour, IPaintManager
    {
        ...
        [SerializeField, Obsolete("This property is obsolete, triangles neighbors data is no longer needed")] 
        private bool useNeighborsVerticesForRaycasts;
        
        [Obsolete("This property is obsolete, triangles neighbors data is no longer needed")] 
        public bool UseNeighborsVerticesForRaycasts
        {
            get => useNeighborsVerticesForRaycasts;
            set => useNeighborsVerticesForRaycasts = value;
        }
        ...
        [Obsolete("This method is obsolete, triangles neighbors data is no longer needed")]
        ...
        [Obsolete("This method is obsolete, triangles neighbors data is no longer needed")]
        public void FillTrianglesData(bool fillNeighbours = false)
        {
        }
